		...
		return function() {
			...
			return t.prototype.init = function() {
				...
				this.getPackage(function(t) {
					t && (e.aTag.href = t.downloadURL, e.size.innerHTML = t.size, e.version.innerHTML = t.version), e.checkbox.checked && t ? e.download.className = "" : e.download.className = ""
				})
			...
			return i(t, e), t.prototype.getID = function() {
				...
				return p.on("changed", function(e) {
					...
					if (i) {
						...
						n.start.className = "", n.start.getElementsByTagName("a")[0].removeAttribute("href"), n.total.innerHTML = "0.00MB";
				...
				e.prototype.hide.call(this), this.start.className = "", this.start.getElementsByTagName("a")[0].removeAttribute("href"), this.total.innerHTML = "0.00MB", this.sysCombo.clean(), this.verCombo.clean(), r.$_("ov-condition-provision").innerHTML = ""
			}, t.strategies = p, t
		}(o["default"]);
	t["default"] = f
}, function(e, t) {
